...
output "autoscaling_iam_instance_profile_arn" {
  description = "ARN assigned by AWS to the instance profile"
  value       = module.autoscaling.iam_instance_profile_arn
}

output "autoscaling_iam_instance_profile_id" {
  description = "Instance profile's ID"
  value       = module.autoscaling.iam_instance_profile_id
}

output "autoscaling_iam_instance_profile_unique" {
